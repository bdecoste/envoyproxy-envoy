...
void configureServerAndExpiredClientCertificate(envoy::api::v2::Listener& listener,
  ...
  client_cert->mutable_certificate_chain()->set_filename(TestEnvironment::substitute(
      "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/expired_san_uri_cert.pem"));
  client_cert->mutable_private_key()->set_filename(TestEnvironment::substitute(
      "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/expired_san_uri_key.pem"));
}
...
TEST_P(OpensslSocketTest, GetCertDigest) {
  ...
  common_tls_context:
    tls_certificates:
      certificate_chain:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/no_san_cert.pem"
      private_key:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/no_san_key.pem"
)EOF";
...
TEST_P(OpensslSocketTest, DISABLED_GetCertDigestInline) {
  ...
  // From test/extensions/transport_sockets/openssl/test_data/san_dns_cert.pem.
  ...
  // From test/extensions/transport_sockets/openssl/test_data/san_dns_key.pem.
  ...
  // From test/extensions/transport_sockets/openssl/test_data/ca_certificates.pem.
  filter_chain->mutable_tls_context()
      ->mutable_common_tls_context()
      ->mutable_validation_context()
      ->mutable_trusted_ca()
  ...
  // From test/extensions/transport_sockets/openssl/test_data/san_uri_cert.pem.
  ...
  // From test/extensions/transport_sockets/openssl/test_data/san_uri_key.pem.
...
TEST_P(OpensslSocketTest, DISABLED_GetCertDigestServerCertWithoutCommonName) {
  ...
  common_tls_context:
    tls_certificates:
      certificate_chain:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_only_dns_cert.pem"
      private_key:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_only_dns_key.pem"
    validation_context:
      trusted_ca:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/ca_cert.pem"
)EOF";
...
TEST_P(OpensslSocketTest, DISABLED_GetUriWithUriSan) {
  ...
  common_tls_context:
    tls_certificates:
      certificate_chain:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_uri_cert.pem"
      private_key:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_uri_key.pem"
)EOF";
...
TEST_P(OpensslSocketTest, DISABLED_FailedClientCertAllowServerExpiredWrongCAVerification) {
  ...
  server_validation_ctx->mutable_trusted_ca()->set_filename(
      TestEnvironment::substitute("{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/fake_ca_cert.pem"));
...
TEST_P(OpensslSocketTest, DISABLED_ClientCertificateHashListVerification) {
  ...
  server_cert->mutable_private_key()->set_filename(
      TestEnvironment::substitute("{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_dns_key.pem"));
  envoy::api::v2::auth::CertificateValidationContext* server_validation_ctx =
      filter_chain->mutable_tls_context()
          ->mutable_common_tls_context()
          ->mutable_validation_context();
  ...
  client_cert->mutable_private_key()->set_filename(
      TestEnvironment::substitute("{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_uri_key.pem"));
...
TEST_P(OpensslSocketTest, DISABLED_FailedClientCertificateHashVerificationWrongCA) {
  ...
  common_tls_context:
    ...
    validation_context:
      trusted_ca:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/fake_ca_cert.pem"
      verify_certificate_hash: "DF:6F:F7:2F:E9:11:65:21:26:8F:6F:2D:D4:96:6F:51:DF:47:98:83:FE:70:37:B3:9F:75:91:6A:C3:04:9D:1A"
)EOF";
...
TEST_P(OpensslSocketTest, DISABLED_FailedClientCertificateSpkiVerificationWrongClientCertificate) {
  ...
  envoy::api::v2::auth::TlsCertificate* client_cert =
      client.mutable_common_tls_context()->add_tls_certificates();
  client_cert->mutable_certificate_chain()->set_filename(
      TestEnvironment::substitute("{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/no_san_cert.pem"));
  client_cert->mutable_private_key()->set_filename(
      TestEnvironment::substitute("{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/no_san_key.pem"));
...
TEST_P(OpensslSocketTest, DISABLED_FlushCloseDuringHandshake) {
  ...
  common_tls_context:
    ...
    validation_context:
      trusted_ca:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/ca_certificates.pem"
)EOF";
...
TEST_P(OpensslSocketTest, DISABLED_TicketSessionResumptionDifferentServerCert) {
  ...
  common_tls_context:
    tls_certificates:
      certificate_chain:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_dns_cert2.pem"
      private_key:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_dns_key2.pem"
  session_ticket_keys:
    keys:
      filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/ticket_key_a"
)EOF";
...
TEST_P(OpensslSocketTest, DISABLED_TicketSessionResumptionDifferentServerCertDifferentSAN) {
  ...
  common_tls_context:
    tls_certificates:
      certificate_chain:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_multiple_dns_cert.pem"
      private_key:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/san_multiple_dns_key.pem"
  session_ticket_keys:
    keys:
      filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/ticket_key_a"
)EOF";
...
TEST_P(OpensslSocketTest, DISABLED_RevokedCertificateCRLInTrustedCA) {
  ...
  common_tls_context:
    ...
    validation_context:
      trusted_ca:
        filename: "{{ test_rundir }}/test/extensions/transport_sockets/openssl/test_data/ca_cert_with_crl.pem"
)EOF";
