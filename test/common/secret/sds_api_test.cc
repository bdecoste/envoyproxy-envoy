...
TEST_F(SdsApiTest, DynamicTlsCertificateUpdateSuccess) {
  ...
  Envoy::Tls::TlsCertificateConfigImpl tls_config(*sds_api.secret());
...
TEST_F(SdsApiTest, DynamicCertificateValidationContextUpdateSuccess) {
  ...
  Envoy::Tls::CertificateValidationContextConfigImpl cvc_config(*sds_api.secret());
...
TEST_F(SdsApiTest, DefaultCertificateValidationContextTest) {
  ...
  Envoy::Tls::CertificateValidationContextConfigImpl cvc_config(merged_cvc);
